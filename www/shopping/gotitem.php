...
<?php
    $ingro = $_POST["keyname"];
    $query = $db->prepare("select * from items where name like '%".$ingro."%'");
    $query->execute();
    $arr = $query->fetchAll();
?>
            ...
            <div id="top-header">
                <div class="container">
                    <ul class="header-links pull-left">
                        <li><a href="#"><i class="fa fa-phone"></i> 178****4713</a></li>
                        <li><a href="#"><i class="fa fa-envelope-o"></i> 2118305466@qq.com</a></li>
